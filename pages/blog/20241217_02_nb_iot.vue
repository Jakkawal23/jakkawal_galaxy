...
const loadBlogLocale = async (lang) => {
  const messages = await import(`~/locales/blogs/20241217_02_nb_iot.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_01.png"
      ...
      <div class="blog-section">
        ...
        <p>{{ t('blog.section1.content01') }}</p>
        <p>{{ t('blog.section1.content02') }}</p>
      </div>

      <!-- Image 2 -->
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_02.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_03.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_04.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_05.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_06.png"
          alt="Smart City"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_07.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_08.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_09.png"
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_10.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_11.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_12.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_13.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_14.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_15.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <div class="blog-section">
        <h3 class="blog-section-title flex items-center gap-2">
          {{ t('blog.section15.heading') }}
        </h3>
        <p>
          {{ t('blog.section15.description') }}
        </p>

        <ul class="blog-list pl-4">
          <li v-for="(item, i) in tm('blog.section15.list')" :key="i">
            • &nbsp;&nbsp;&nbsp; {{ item }}
          </li>
        </ul>
      </div>
      ...
      <figure class="w-full">
        <img
          src="/images/blog/20241217_02/20241217_02_16.png"
          alt="แล้วคุณ ให้คำนิยามของ IoT ว่าอย่างไร ?"
          class="rounded-2xl shadow-lg w-full object-cover blog-image"
        />
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <div class="blog-highlight">
        <span class="font-semibold text-white">
          {{ t('blog.section16.heading') }}
        </span>
        {{ t('blog.section16.content') }}
      </div>
      ...
      <div class="blog-section flex flex-col gap-6">
        <div class="flex flex-wrap gap-2">
          <span
            v-for="tag in ['Iot', 'Internet Of Things', 'Internet Of Everything', 'IOT', 'Nb IoT', 'Narrowband IoT']"
            :key="tag"
            class="blog-tag"
          >
            #{{ tag }}
