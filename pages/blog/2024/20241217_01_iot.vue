...
const loadBlogLocale = async (lang) => {
  const messages = await import(`~/locales/blogs/2024/20241217_01_iot.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <!-- Image 1 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_01.png']"/>
      ...
      <!-- Image 2 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_02.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 3 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_03.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 4 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_04.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 5 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_05.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 6 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_06.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 7 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_07.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <div class="blog-section">
        ...
        <p>{{ t('blog.section8.content01') }}</p>
        <p>{{ t('blog.section8.content02') }}</p>
      </div>

      <!-- Image 8 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_08.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <!-- Image 9 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/blog/2024/20241217_01/20241217_01_09.png']"/>
        <figcaption class="text-center text-gray-400 text-sm mt-2 italic">
      ...
      <div class="blog-section flex flex-col gap-6">
        <div class="flex flex-wrap gap-2">
          <span
            v-for="tag in ['Iot', 'Internet Of Things', 'Internet Of Everything', 'IOT']"
            :key="tag"
            class="blog-tag"
          >
            #{{ tag }}
