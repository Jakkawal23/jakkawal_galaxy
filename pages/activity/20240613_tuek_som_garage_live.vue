...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <figure class="w-full">
        <img
          src="/images/activity/20240613/20240613_01.png"
      ...
      <div class="blog-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
          <!-- <img src="/images/activity/20240613/20240613_02.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_03.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_04.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_05.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_06.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_07.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_08.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_09.png" class="rounded-lg object-cover" />
          <img src="/images/activity/20240613/20240613_10.png" class="rounded-lg object-cover" /> -->
        </div>
      </div>
