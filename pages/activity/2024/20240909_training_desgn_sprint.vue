...
const loadActivityLocale = async (lang) => {
  const messages = await import(`~/locales/activity/2024/20240909_training_desgn_sprint.${lang}.json`)
  ...
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <div class="blog-section">
        ...
        <ImageGallery 
          :images="[
            '/images/activity/2024/20240909/20240909_01.png',
            '/images/activity/2024/20240909/20240909_02.png',
            '/images/activity/2024/20240909/20240909_03.png',
            '/images/activity/2024/20240909/20240909_04.png',
            '/images/activity/2024/20240909/20240909_05.png',
            '/images/activity/2024/20240909/20240909_06.png',
          ]" 
        />
      </div>
