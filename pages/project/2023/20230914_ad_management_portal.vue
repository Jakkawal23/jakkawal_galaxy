...
const loadProjectLocale = async (lang) => {
  const messages = await import(`~/locales/project/2023/20230914_ad_management_portal.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <!-- Image 1 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/project/2022/20230914/20230914_01.png']"/>
      ...
      <div class="blog-section">
        ...
        <ImageGallery 
          :images="[
            '/images/project/2023/20230914/20230914_02.png',
            '/images/project/2023/20230914/20230914_03.png',
            '/images/project/2023/20230914/20230914_04.png',
            '/images/project/2023/20230914/20230914_05.png',
            '/images/project/2023/20230914/20230914_06.png',
            '/images/project/2023/20230914/20230914_07.png',
          ]" 
        />
      </div>
