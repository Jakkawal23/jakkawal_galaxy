...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <figure class="w-full">
        <img
          src="/images/project/20250801/20250801_01.png"
      ...
      <div class="blog-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
          <img src="/images/project/20250801/20250801_02.png" class="rounded-lg object-cover" />
          <img src="/images/project/20250801/20250801_03.png" class="rounded-lg object-cover" />
          <img src="/images/project/20250801/20250801_04.png" class="rounded-lg object-cover" />
          <img src="/images/project/20250801/20250801_05.png" class="rounded-lg object-cover" />
          <img src="/images/project/20250801/20250801_06.png" class="rounded-lg object-cover" />
          <img src="/images/project/20250801/20250801_07.png" class="rounded-lg object-cover" />
        </div>
      </div>
