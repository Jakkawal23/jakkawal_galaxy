...
const loadProjectLocale = async (lang) => {
  const messages = await import(`~/locales/project/2025/20250128_chinese_new_year_wishes.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <!-- Image 1 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/project/2025/20250128/20250128_01.png']"/>
      ...
      <div class="blog-section">
        ...
        <ImageGallery 
          :images="[
            '/images/project/2025/20250128/20250128_02.png',
            '/images/project/2025/20250128/20250128_03.png',
            '/images/project/2025/20250128/20250128_04.png',
            '/images/project/2025/20250128/20250128_05.png',
            '/images/project/2025/20250128/20250128_06.png',
            '/images/project/2025/20250128/20250128_07.png',
          ]" 
        />
      </div>
