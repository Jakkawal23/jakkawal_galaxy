...
const loadProjectLocale = async (lang) => {
  const messages = await import(`~/locales/project/2025/20250112_debt_management_system.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <!-- Image 1 -->
      <figure class="w-full">
        <ImageGallery :images="['/images/project/2025/20250112/20250112_01.png']"/>
      ...
      <div class="blog-section">
        ...
        <ImageGallery 
          :images="[
            '/images/project/2025/20250112/20250112_02.png',
            '/images/project/2025/20250112/20250112_03.png',
            '/images/project/2025/20250112/20250112_04.png',
            '/images/project/2025/20250112/20250112_05.png',
            '/images/project/2025/20250112/20250112_06.png',
            '/images/project/2025/20250112/20250112_07.png',
          ]" 
        />
      </div>
