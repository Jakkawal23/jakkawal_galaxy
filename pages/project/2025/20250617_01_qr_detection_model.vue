...
const loadProjectLocale = async (lang) => {
  const messages = await import(`~/locales/project/2025/20250617_01_qr_detection_model.${lang}.json`)
...
<template>
  <article class="blog-detail active text-gray-200" data-page="blog-detail">
    ...
    <section class="blog-content px-4 md:px-12 lg:px-32 py-10 space-y-12">
      ...
      <figure class="w-full">
        <img
          src="/images/project/2025/20250617_01/20250617_01_01.png"
      ...
      <div class="blog-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
          <img src="/images/project/2025/20250617_01/20250617_01_02.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_03.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_04.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_05.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_06.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_07.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_08.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_09.png" class="rounded-lg object-cover" />
          <img src="/images/project/2025/20250617_01/20250617_01_10.png" class="rounded-lg object-cover" />
        </div>
      </div>
